      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              name: {
                type: 'string',
                description: 'Name of the context window'
              },
              description: {
                type: 'string',
                description: 'Description of the context window purpose'
              },
              symbols: {
                type: 'array',
                items: { type: 'string' },
        ...
        {
          name: 'add_context',
          description: 'Add context information to the active window',
          inputSchema: {
            type: 'object',
            properties: {
              windowId: {
                type: 'string',
                description: 'ID of the context window (optional, uses active if not provided)'
              },
              content: {
                type: 'string',
        ...
        },
        {
          ...
          description: 'Set the active context window',
          inputSchema: {
            type: 'object',
            properties: {
              windowId: {
                type: 'string',
                description: 'ID of the window to set as active'
              }
            },
            required: ['windowId']
          }
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              targetWindow: {
                type: 'string',
                description: 'Name for the new merged window'
              },
              strategy: {
                type: 'string',
