...
1. Deploy your app to your hosting provider of choice.
3. In ChatGPT, navigate to **Settings → [Connectors](https://chatgpt.com/#settings/Connectors) → Create** and add your MCP server URL with the `/mcp` path (e.g., `https://your-app.example.com/mcp`)
...
Set `BASE_URL` to the public origin of your deployment so assets resolve correctly when the app renders inside an iframe. In development, the app defaults to `http://localhost:3000`.
